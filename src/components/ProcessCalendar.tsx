...
export const ProcessCalendar: React.FC<ProcessCalendarProps> = ({
      ...
      days.push(
        <button
          ...
          className={`
            ...
            min-h-[1.6rem] sm:min-h-[1.4rem] md:min-h-[1.2rem] lg:h-20 xlg:h-20 2xl:h-[152px]
            max-h-[3rem] sm:max-h-[2.5rem] md:max-h-[2rem] lg:max-h-20 xlg:max-h-20 2xl:max-h-[152px]
  ...
  return (
    <div className="rounded-xl shadow-lg p-2 sm:p-2 md:p-2 lg:p-1.5" style={{ backgroundColor: colors.bgSecondary }}>
      <div className="flex items-center justify-between mb-1.5 sm:mb-1.5 md:mb-1.5 lg:mb-1 px-4">
