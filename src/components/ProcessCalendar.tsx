...
export const ProcessCalendar: React.FC<ProcessCalendarProps> = ({
      ...
      days.push(
        ...
        >
          <div className="flex flex-col items-center justify-center h-full gap-0.5">
            <span className="leading-none text-[10px]">{displayDay}</span>
  ...
  return (
    <div className="rounded-xl shadow-lg p-2" style={{ backgroundColor: colors.bgSecondary }}>
      <div className="flex items-center justify-between mb-2">
        <h2 className="text-sm font-bold flex items-center gap-1" style={{ color: colors.textPrimary }}>
          <CalendarIcon className="w-3.5 h-3.5" style={{ color: colors.accent }} />
          {monthNames[currentMonth.getMonth()]} {currentMonth.getFullYear()}
        </h2>
        <div className="flex gap-0.5">
          <button
            onClick={handleToday}
            className="px-1.5 py-0.5 text-xs font-medium rounded transition-all calendar-today-btn"
            style={{
      ...
      <div className="mt-1.5 pt-1.5" style={{ borderTop: `1px solid ${colors.border}` }}>
