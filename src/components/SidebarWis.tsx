    ...
    <>
      ...
      <aside className={`hidden lg:flex ${isCollapsed ? 'w-20' : 'w-64'} h-screen fixed left-0 top-0 flex-col font-body transition-[width] duration-300 ease-in-out`} style={{ backgroundColor: colors.bgPrimary, borderRight: `1px solid ${colors.border}` }}>
        <div className="p-6 lg:max-h-[900px]:p-0.5 lg:max-h-[720px]:p-0 flex flex-col items-center justify-center flex-shrink-0">
          <button
            onClick={onNavigateToApp}
            className="hover:opacity-80 transition-opacity w-10 h-10 lg:max-h-[900px]:w-3.5 lg:max-h-[900px]:h-3.5 lg:max-h-[720px]:w-2 lg:max-h-[720px]:h-2 flex items-center justify-center"
            title="Ir para página inicial"
          >
            <img
              src={colors.logo}
              alt="Wis Legal"
              className="h-10 w-10 lg:max-h-[900px]:h-3.5 lg:max-h-[900px]:w-3.5 lg:max-h-[720px]:h-2 lg:max-h-[720px]:w-2 object-contain"
            />
          </button>
        </div>
        ...
        <nav className="flex-1 px-3 lg:max-h-[900px]:px-0.5 lg:max-h-[720px]:px-0 flex flex-col overflow-y-auto scrollbar-thin scrollbar-thumb-gray-600 scrollbar-track-transparent">
          <div>
            ...
            >
              {isCollapsed ? <Menu className="w-5 h-5 lg:max-h-[900px]:w-3 lg:max-h-[900px]:h-3 lg:max-h-[720px]:w-1.5 lg:max-h-[720px]:h-1.5" /> : <ChevronLeft className="w-5 h-5 lg:max-h-[900px]:w-3 lg:max-h-[900px]:h-3 lg:max-h-[720px]:w-1.5 lg:max-h-[720px]:h-1.5" />}
            </button>
            ...
            <button
              ...
              title="Busca"
            >
              <Search className="w-5 h-5 lg:max-h-[900px]:w-3 lg:max-h-[900px]:h-3 lg:max-h-[720px]:w-1.5 lg:max-h-[720px]:h-1.5 flex-shrink-0" />
              {!isCollapsed && <span className="ml-3 lg:max-h-[900px]:ml-0.5 lg:max-h-[720px]:ml-0 text-sm lg:max-h-[900px]:text-[9px] lg:max-h-[720px]:text-[5px] font-medium">Busca</span>}
            </button>
            ...
            <button
              ...
              title="Novo processo"
            >
              <Plus className="w-5 h-5 lg:max-h-[900px]:w-3 lg:max-h-[900px]:h-3 lg:max-h-[720px]:w-1.5 lg:max-h-[720px]:h-1.5 flex-shrink-0" />
              {!isCollapsed && <span className="ml-3 lg:max-h-[900px]:ml-0.5 lg:max-h-[720px]:ml-0 text-sm lg:max-h-[900px]:text-[9px] lg:max-h-[720px]:text-[5px] font-medium">Novo processo</span>}
            </button>
            ...
            >
              <FileText className="w-5 h-5 lg:max-h-[900px]:w-3 lg:max-h-[900px]:h-3 lg:max-h-[720px]:w-1.5 lg:max-h-[720px]:h-1.5 flex-shrink-0" />
              {!isCollapsed && <span className="ml-3 lg:max-h-[900px]:ml-0.5 lg:max-h-[720px]:ml-0 text-sm lg:max-h-[900px]:text-[9px] lg:max-h-[720px]:text-[5px] font-medium">Meus processos</span>}
            </button>
            ...
            <button
              ...
              title="Chat"
            >
              <MessageSquare className="w-5 h-5 lg:max-h-[900px]:w-3 lg:max-h-[900px]:h-3 lg:max-h-[720px]:w-1.5 lg:max-h-[720px]:h-1.5 flex-shrink-0" />
              {!isCollapsed && <span className="ml-3 lg:max-h-[900px]:ml-0.5 lg:max-h-[720px]:ml-0 text-sm lg:max-h-[900px]:text-[9px] lg:max-h-[720px]:text-[5px] font-medium">Chat</span>}
            </button>
            ...
            <button
              ...
              title="Meu workspace"
            >
              <Users className="w-5 h-5 lg:max-h-[900px]:w-3 lg:max-h-[900px]:h-3 lg:max-h-[720px]:w-1.5 lg:max-h-[720px]:h-1.5 flex-shrink-0" />
              {!isCollapsed && <span className="ml-3 lg:max-h-[900px]:ml-0.5 lg:max-h-[720px]:ml-0 text-sm lg:max-h-[900px]:text-[9px] lg:max-h-[720px]:text-[5px] font-medium">Meu workspace</span>}
            </button>
            ...
            <button
              ...
              title="Agenda"
            >
              <Calendar className="w-5 h-5 lg:max-h-[900px]:w-3 lg:max-h-[900px]:h-3 lg:max-h-[720px]:w-1.5 lg:max-h-[720px]:h-1.5 flex-shrink-0" />
              {!isCollapsed && <span className="ml-3 lg:max-h-[900px]:ml-0.5 lg:max-h-[720px]:ml-0 text-sm lg:max-h-[900px]:text-[9px] lg:max-h-[720px]:text-[5px] font-medium">Agenda</span>}
            </button>
          </div>
