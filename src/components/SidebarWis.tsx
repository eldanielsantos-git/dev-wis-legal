  ...
  return (
    <>
      ...
      <aside className={`hidden lg:flex ${isCollapsed ? 'w-20' : 'w-64'} h-screen fixed left-0 top-0 flex-col font-body transition-[width] duration-300 ease-in-out`} style={{ backgroundColor: colors.bgPrimary, borderRight: `1px solid ${colors.border}` }}>
        <div className="p-6 max-h-900:p-2 flex flex-col items-center justify-center flex-shrink-0">
          <button
            onClick={onNavigateToApp}
            className="hover:opacity-80 transition-opacity w-10 h-10 max-h-900:w-8 max-h-900:h-8 flex items-center justify-center"
            title="Ir para página inicial"
          >
            <img
              src={colors.logo}
              alt="Wis Legal"
              className="h-10 w-10 max-h-900:h-8 max-h-900:w-8 object-contain"
            />
          </button>
        </div>

        <nav className="flex-1 px-3 max-h-900:px-1.5 flex flex-col overflow-y-auto scrollbar-thin scrollbar-thumb-gray-600 scrollbar-track-transparent">
          <div>
            <button
              onClick={handleToggleCollapse}
              className={`w-full flex items-center py-3 max-h-900:py-1 rounded-lg transition-colors mb-2 max-h-900:mb-1 ${isCollapsed ? 'justify-center' : 'px-4 max-h-900:px-2'}`}
              style={{ color: colors.textPrimary }}
              onMouseEnter={(e) => e.currentTarget.style.backgroundColor = hoverBg}
              onMouseLeave={(e) => e.currentTarget.style.backgroundColor = 'transparent'}
              title={isCollapsed ? "Expandir menu" : "Retrair menu"}
            >
              {isCollapsed ? <Menu className="w-5 h-5 max-h-900:w-4 max-h-900:h-4" /> : <ChevronLeft className="w-5 h-5 max-h-900:w-4 max-h-900:h-4" />}
            </button>

            <button
              onClick={() => onSearchClick?.()}
              className={`w-full flex items-center py-3 max-h-900:py-1.5 rounded-lg transition-colors ${isCollapsed ? 'justify-center' : 'px-4 max-h-900:px-2'}`}
              style={{ color: colors.textPrimary }}
              onMouseEnter={(e) => e.currentTarget.style.backgroundColor = hoverBg}
              onMouseLeave={(e) => e.currentTarget.style.backgroundColor = 'transparent'}
              title="Busca"
            >
              <Search className="w-5 h-5 max-h-900:w-4 max-h-900:h-4 flex-shrink-0" />
              {!isCollapsed && <span className="ml-3 max-h-900:ml-1.5 text-sm max-h-900:text-xs font-medium">Busca</span>}
            </button>
            ...
            <button
              ...
              title="Novo processo"
            >
              <Plus className="w-5 h-5 max-h-900:w-4 max-h-900:h-4 flex-shrink-0" />
              {!isCollapsed && <span className="ml-3 max-h-900:ml-1.5 text-sm max-h-900:text-xs font-medium">Novo processo</span>}
            </button>
            ...
            >
              <FileText className="w-5 h-5 max-h-900:w-4 max-h-900:h-4 flex-shrink-0" />
              {!isCollapsed && <span className="ml-3 max-h-900:ml-1.5 text-sm max-h-900:text-xs font-medium">Meus processos</span>}
            </button>
            ...
            <button
              ...
              title="Chat"
            >
              <MessageSquare className="w-5 h-5 max-h-900:w-4 max-h-900:h-4 flex-shrink-0" />
              {!isCollapsed && <span className="ml-3 max-h-900:ml-1.5 text-sm max-h-900:text-xs font-medium">Chat</span>}
            </button>
            ...
            <button
              ...
              title="Meu workspace"
            >
              <Users className="w-5 h-5 max-h-900:w-4 max-h-900:h-4 flex-shrink-0" />
              {!isCollapsed && <span className="ml-3 max-h-900:ml-1.5 text-sm max-h-900:text-xs font-medium">Meu workspace</span>}
            </button>
            ...
            <button
              ...
              title="Agenda"
            >
              <Calendar className="w-5 h-5 max-h-900:w-4 max-h-900:h-4 flex-shrink-0" />
              {!isCollapsed && <span className="ml-3 max-h-900:ml-1.5 text-sm max-h-900:text-xs font-medium">Agenda</span>}
            </button>
          </div>

          <div className="flex-1"></div>

          <div className={`${isCollapsed ? '' : 'pt-4 max-h-900:pt-2'}`} style={!isCollapsed ? { borderTop: `1px solid ${colors.border}` } : {}}>
            <button
              onClick={toggleTheme}
              className={`w-full flex items-center py-3 max-h-900:py-1.5 rounded-lg transition-colors ${isCollapsed ? 'justify-center' : 'px-4 max-h-900:px-2'}`}
              style={{ color: colors.textPrimary }}
            ...
            >
              {theme === 'dark' ? <Sun className="w-5 h-5 max-h-900:w-4 max-h-900:h-4 flex-shrink-0" /> : <Moon className="w-5 h-5 max-h-900:w-4 max-h-900:h-4 flex-shrink-0" />}
              {!isCollapsed && <span className="ml-3 max-h-900:ml-1.5 text-sm max-h-900:text-xs font-medium">{theme === 'dark' ? 'Modo claro' : 'Modo escuro'}</span>}
            </button>
            ...
            <button
              ...
              title="Tokens"
            >
              <Coins className="w-5 h-5 max-h-900:w-4 max-h-900:h-4 flex-shrink-0" />
              {!isCollapsed && <span className="ml-3 max-h-900:ml-1.5 text-sm max-h-900:text-xs font-medium">Tokens</span>}
            </button>
            ...
            >
              <UserPlus className="w-5 h-5 max-h-900:w-4 max-h-900:h-4 flex-shrink-0" />
              {!isCollapsed && <span className="ml-3 max-h-900:ml-1.5 text-sm max-h-900:text-xs font-medium">Enviar convite</span>}
            </button>

          </div>
        </nav>

        <div className="p-2 max-h-900:p-1 flex-shrink-0" style={!isCollapsed ? { borderTop: `1px solid ${colors.border}` } : {}}>
          {isCollapsed ? (
            <div className="flex items-center py-2 max-h-900:py-1 justify-center">
              <UserAvatarMenu
                avatarUrl={profile?.avatar_url}
                firstName={profile?.first_name}
                lastName={profile?.last_name}
            ...
            <div className="flex items-center py-2 max-h-900:py-1 px-3 max-h-900:px-2">
              <UserAvatarMenu
                avatarUrl={profile?.avatar_url}
                firstName={profile?.first_name}
                lastName={profile?.last_name}
