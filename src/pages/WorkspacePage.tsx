            ...
            <div className="flex flex-wrap gap-6 justify-center lg:justify-start">
              {(activeTab === 'received' ? sharedWithMe : myShares).map((share) => {
                ...
                const processoData: Processo = {
                  ...
                  transcricao: share.processo.transcricao || { totalPages: 0 },
                  tokens_consumed: share.processo.tokens_consumed || 0,
                  total_prompts: share.processo.total_prompts || 9,
                  current_prompt_number: share.processo.current_prompt_number || 0,
                  current_llm_model_name: share.processo.current_llm_model_name,
                  last_error_type: share.processo.last_error_type,
